 ...
 *
 * Detects changes to all configuration files tracked by cm dependencies,
 * not just check.toml files.
 */
...
export interface DependencyChange {
  ...
  /** Whether this is an always-tracked file (check.toml, workflows) */
...
export interface DependencyChanges {
  ...
  hasChanges: boolean;
  /** Error if cm dependencies failed */
  error?: string;
}
 ...
 *
 * Uses cm dependencies to get the list of tracked files, then checks
 ...
 *
 * Convenience function that returns just the file list from cm dependencies.
 *
 * @param repoPath - Path to the repository
