/**
 * Tier validation using check-my-toolkit's `cm validate tier` command.
...
/**
 * Raw JSON output format from `cm validate tier --format json`
 */
 ...
 * Uses the `cm validate tier` command from check-my-toolkit.
 *
